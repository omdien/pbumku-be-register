...
import Tb_trader_upt from "./tb_trader_upt.js";
...
Tb_r_trader.hasMany(Tb_trader_upt, { foreignKey: 'KODE_TRADER' });
Tb_trader_upt.belongsTo(Tb_r_trader, { foreignKey: 'KODE_TRADER' });
